...
# Đường dẫn đến các plugin Qt. Thường thì bạn sẽ không cần dòng này nếu PyQt5 được cài đặt đúng cách,
# hoặc nếu thư mục 'platforms' nằm ở một vị trí mà PyQt5 tự động tìm thấy.
# Nếu bạn vẫn gặp lỗi liên quan đến Qt platform plugins, hãy kiểm tra lại đường dẫn này
# so với vị trí của thư mục 'platforms' trong project của bạn.
# Ví dụ: nếu vigenere_cipher.py nằm trong 'lab_03' và 'platforms' nằm ngang hàng với 'lab_03', thì đường dẫn này là đúng.
os.environ['QT_QPA_PLATFORM_PLUGIN_PATH'] = "../platforms"

# Nhập lớp Ui_MainWindow từ file vigenere.py đã được tạo từ vigenere.ui
# Giả sử file vigenere.py nằm trong thư mục 'ui'
from ui.vigenere import Ui_MainWindow # Đảm bảo đường dẫn và tên file này chính xác
...
class MyApp(QMainWindow):
    ...
    def call_api_encrypt(self):
        # URL của API Flask cho mã hóa Vigenere
    ...
    def call_api_decrypt(self):
        # URL của API Flask cho giải mã Vigenere
